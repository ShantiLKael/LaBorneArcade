...
<section class="container mx-auto px-4 py-8">
	<div class="flex flex-col md:flex-row items-center rounded-sm p-5 md:p-12 shadow-lg mb-10">
		<!-- Image -->
