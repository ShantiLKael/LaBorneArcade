		...
		<?= form_open('/qui-sommes-nous') ?>
			...
			<div class="mb-5">
				...
				<div class="relative flex items-center">
					<?php
					$focusRIng = (validation_show_error('email')) ? 'border-red-600 focus:ring-red-500' : 'border-gray-600 focus:ring-2 focus:ring-green-600';
					echo form_input([
						'name'          => 'email',
						'id'            => 'email',
			...
			<div class="mb-5">
				...
				<div class="relative flex items-center">
					<?php
					$focusRIng = (validation_show_error('mdp')) ? 'border-red-600 focus:ring-red-500' : 'border-gray-600 focus:ring-2 focus:ring-green-600';
					echo form_input([
						'name'          => 'mdp',
						'id'            => 'mdp',
						'class'         => 'w-full text-sm bg-gray-700 border border-gray-300 px-4 py-3 rounded-lg outline-green-600 focus:outline-none focus:ring-2 '.$focusRIng,
