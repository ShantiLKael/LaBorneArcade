...
<section class="text-gray-100 text-xs py-12">
<div class="max-w-5xl mx-auto px-5 sm:px-0">
	<h2 class="text-center text-2xl font-bold mb-10 ml-10">Contactez nous</h2>
		...
		<div class="space-y-4">
			<div class="flex items-center space-x-4">
				...
				<div>
					...
					<p class="text-sm">07 68 53 46 26</p>
				</div>
			</div>
			<div class="flex items-center space-x-4">
				...
				<div>
					<p class="font-bold text-lg">E-mail</p>
					<p class="text-sm">Contact@LaBorneArcade.com</p>
				</div>
			</div>
			<div class="flex items-center space-x-4">
				...
				<div>
					<p class="font-bold text-lg">Telephone</p>
					<p class="text-sm">07 68 53 46 26</p>
				</div>
			</div>
		</div>
	...
	<div class="bg-gray-800 p-6">
		<h3 class="uppercase text-lg font-semibold">Envoyer nous votre message</h3>
		<?= form_open('/contact',['class' => 'space-y-4']); ?>
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
				<div>
					<?= form_label('Nom', 'nom', ['class' => 'block text-sm font-medium mb-1 ml-1']); ?>
					
					<?= form_input([
						'name'          => 'nom',
						'id'            => 'nom',
						'class'         => 'w-full bg-gray-700 text-gray-100 text-xs rounded-lg border px-4 py-2 mb-2 focus:outline-none focus:ring-2 border-gray-600 focus:ring-green-500',
						'value'         => set_value('nom'),
						'required'
					]); ?>
				</div>
				<div>
					<?= form_label('Entreprise', 'entreprise', ['class' => 'block text-sm font-medium mb-1 ml-1']); ?>
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
				<div>
					<?= form_label('Téléphone', 'phone', ['class' => 'block text-sm font-medium mb-1 ml-1']); ?>
					...
					echo form_input([
						'name'          => 'phone',
						'id'            => 'phone-number',
						'class'         => 'w-full bg-gray-700 text-gray-100 text-xs rounded-lg border px-4 py-2 mb-2 focus:outline-none focus:ring-2 '.$focusRIng,
				...
				<div>
					<?= form_label('Email', 'email', ['class' => 'block text-sm font-medium mb-1 ml-1']); ?>
			...
			<div>
					<?= form_label('Message', 'message', ['class' => 'block text-sm font-medium mb-1 ml-1']); ?>
			...
			<?= form_submit('submit', 'Envoyer', "class='w-full bg-green-700 text-gray-100 text-xs font-semibold rounded-lg px-4 py-2 mb-2 hover:bg-green-600'"); ?>
