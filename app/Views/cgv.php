...
<div class="my-20 max-w-screen-lg mx-auto px-5 sm:px-8 py-10 bg-gray-800 text-gray-300 shadow-lg rounded-lg">
    <!-- Titre principal -->
    <header class="border-b border-gray-600 pb-6">
        <h1 class="text-4xl font-bold text-center text-green-400">Conditions Générales de Vente</h1>
        <p class="mt-3 text-center text-gray-400">Applicables aux produits vendus sur www.labornearcade.com</p>
    </header>
    ...
    <main class="space-y-10 mt-8">
        ...
        <section>
            ...
            <ul class="list-disc list-inside mt-4 text-gray-400">
                <li>Les commandes sont payables en euros.</li>
                <li>Les produits demeurent la propriété de La Borne jusqu’au paiement complet.</li>
                <li>Les frais de livraison sont ajoutés lors de la commande.</li>
            </ul>
        </section>
        ...
        <section>
            ...
            <p class="mt-4">
                La Borne se réserve le droit de ne pas enregistrer un paiement, et de ne pas confirmer une commande pour
                quelque raison que ce soit, notamment en cas de problème d'approvisionnement ou de difficulté concernant
                la commande reçue.
            </p>
        </section>
        ...
        <section>
            ...
            <p class="mt-4">
                ...
                présentes CGV sans exception ni réserve.
            </p>
            <p class="mt-4">
        ...
        <section>
            ...
            <p class="mt-4">
                En cas de non-paiement ou de problème de règlement, votre commande ne sera pas validée et un email vous
                sera envoyé pour vous informer. Les produits commandés restent la propriété de La Borne jusqu'au
        ...
        <section>
            ...
            <p class="mt-4">
                Les retours sont à effectuer dans leur état d'origine et complets. Les frais de retour sont à votre
                charge. En cas d'exercice de ce droit, La Borne procédera au remboursement dans un délai de 14 jours
        ...
        <section>
            ...
            <p class="mt-4">
                ...
                commande sera automatiquement annulée et aucun débit ne sera effectué.
            </p>
        </section>
        ...
        <section>
            ...
            <p class="mt-4">
                ...
                soit, même partiellement, des éléments du site.
            </p>
        </section>
        ...
        <section>
            ...
            <p class="mt-4">
                ...
                concernées comme preuve des communications, commandes, paiements et transactions intervenues entre les
                parties.
            </p>
        </section>
    ...
    <!-- Footer -->
    <footer class="border-t border-gray-600 mt-10 pt-6 text-center text-sm text-gray-400">
        <p>© <?= date('Y') ?> La Borne. Tous droits réservés.</p>
    </footer>
</div>
