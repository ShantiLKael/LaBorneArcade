...
<section class="max-w-2xl mx-auto mt-10">
	<div class="bg-gradient-to-r from-teal-900 to-dark-blue text-center pt-4">
...
<div class="max-w-6xl mx-auto">
	<div class="text-center md:text-right md:px-3 text-sm pb-6">
		<a href="<?php echo base_url('/qui-sommes-nous') ?>" class="hover:text-teal-500">Qui sommes nous</a>
		<span class="mx-2">|</span>
		<a href="<?php echo base_url('/contact') ?>" class="hover:text-teal-500">Me contacter</a>
		<span class="mx-2">|</span>
		<a href="<?php echo base_url('/condition-de-vente') ?>" class="hover:text-teal-500">CGV</a>
		<span class="mx-2">|</span>
		<a href="<?php echo base_url('/articles') ?>" class="hover:text-teal-500">Blog</a>
	</div>
	...
	<div class="flex gap-4 mb-4 sm:mb-0 sm:px-3">
		...
		<!-- WhatsApp -->
		<a href="https://wa.me/33768534626" class="text-gray-100 text-xs hover:text-teal-500">
			<svg class="w-10 h-11" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
		...
		<!-- Instagram -->
		<a href="https://www.instagram.com/la_borne/" class="text-gray-100 text-xs hover:text-teal-500">
			<svg class="w-10 h-11" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
		...
		<!-- Facebook -->
		<a href="https://www.facebook.com/LaBorneArcade" class="text-gray-100 text-xs hover:text-teal-500 hover:border-teal-500">
			<svg class="w-7 h-11 fill-current" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
