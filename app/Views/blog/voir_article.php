...
<div class="text-white py-12 px-6">
	...
	<!-- Grille des article -->
	<div class="bg-light-teal grid-cols-1 md:grid-cols-1 gap-6 max-w-7xl mx-auto">
		<!-- Titre principal -->
	...
	<!-- Article -->
		<?php if (!empty($article)) : ?>
			...
			<div class="center w-[25vw] h-[30px] flex items-center justify-center"> <h3 class="text-center text-3xl font-bold mb-4"><?= $article->titre ?></h3>  </div>
