...
-- Article 1 : "Les Précurseurs des Bornes d'Arcade"
...
-- Article 2 : "Les Années Dorées des Salles d'Arcade"
INSERT INTO ArticleBlog (titre, texte, id_Utilisateur) 
VALUES 
(
...
-- Article 3 : "Les Jeux d'Arcade les Plus Rares"
INSERT INTO ArticleBlog (titre, texte, id_Utilisateur) 
VALUES 
(
...
-- Article 4 : "L'Expérience Sociale des Bornes d'Arcade"
INSERT INTO ArticleBlog (titre, texte, id_Utilisateur) 
VALUES 
(
...
-- Article 5 : "Les Bornes d'Arcade dans le Cinéma"
INSERT INTO ArticleBlog (titre, texte, id_Utilisateur) 
VALUES 
(
...
-- Article 6 : "Pourquoi Restaurer une Borne d'Arcade ?"
INSERT INTO ArticleBlog (titre, texte, id_Utilisateur) 
VALUES 
(
...
-- Article 7 : "Les Bornes d'Arcade et la Réalité Virtuelle"
INSERT INTO ArticleBlog (titre, texte, id_Utilisateur) 
VALUES 
(
...
-- Article 8 : "Les Bornes d'Arcade : Un Investissement Rentable ?"
INSERT INTO ArticleBlog (titre, texte, id_Utilisateur) 
VALUES 
(
...
('public/assets/image/article/1/borneCote.webp'),
('public/assets/image/article/1/borneFace.webp'),
('public/assets/image/article/2/borneCoteLoin.webp'),
('public/assets/image/article/2/clavier.webp'),
('public/assets/image/article/2/telephone.webp');
...
((SELECT id_Image FROM Image WHERE chemin = 'public/assets/image/article/1/borneCote.webp'), 1),
((SELECT id_Image FROM Image WHERE chemin = 'public/assets/image/article/1/borneFace.webp'), 1);

-- Article 2
INSERT INTO ImageArticleBlog (id_Image, id_ArticleBlog) VALUES
((SELECT id_Image FROM Image WHERE chemin = 'public/assets/image/article/2/borneCoteLoin.webp'), 2),
((SELECT id_Image FROM Image WHERE chemin = 'public/assets/image/article/2/clavier.webp'), 2),
((SELECT id_Image FROM Image WHERE chemin = 'public/assets/image/article/2/telephone.webp'), 2);
